      ...
      <Input style={{ 
        ...
        <Space>
          <Button
            ...
            icon={<BsFolderFill style={{ marginRight: "0.5rem", color: "#AC6DDE" }} />}
          >
            {" "}
            Design{" "}
          </Button>
          <Button
            ...
            icon={<AiFillCalendar style={{ marginRight: "0.5rem", color: "#3FB970" }} />}
          >
            {" "}
            Today{" "}
          </Button>
          <Button
            ...
            icon={<BsFillFlagFill style={{ marginRight: "0.5rem", color: "#EA4848" }} />}
          ></Button>
        </Space>
        <Button
          style={{
